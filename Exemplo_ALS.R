...
#P,Q,R - número de componentes do 1º,2º e 3º modo respetivamente. S=P+Q+R
#k1,k2,k3 - número de iterações
#Frob1, Frob2, Frob3 - Norma de Frobenius em cada inicialização
#%1,%2,%3 - proporção de variância explicada
colnames(Final)=c("P","Q","R","S","K1","Frob1","%1","K2","Frob2","%2","K3","Frob3","%3") 
View(Final) #Tabela com todos os modelos

colMeans(Final[,c(5,8,11)])#iterações medias em cada modelo
